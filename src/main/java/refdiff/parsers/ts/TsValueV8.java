...
class TsValueV8 implements Closeable {

    private final Object value;
    private final V8Object o;
    private final boolean defined;
    private final Function<Object, String> toJsonFunction;
    private final List<TsValueV8> children = new ArrayList<>();

    public TsValueV8(Object value, Function<Object, String> toJsonFunction) {
        this.value = value;
    ...
    public TsValueV8 get(String member) {
        if (o != null) {
            if (o.contains(member)) {
                return addChild(new TsValueV8(o.get(member), toJsonFunction));
            } else {
    ...
    public TsValueV8 get(int pos) {
        if (o != null) {
            if (o instanceof V8Array) {
                V8Array array = (V8Array) o;
                return addChild(new TsValueV8(array.get(pos), toJsonFunction));
            } else {
    ...
    private TsValueV8 addChild(TsValueV8 value) {
        if (value.o != null) {
